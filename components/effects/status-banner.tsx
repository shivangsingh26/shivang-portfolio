  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="relative flex items-center gap-3 overflow-hidden rounded-full border border-border bg-background/85 px-4 py-1.5 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
            <span
              aria-hidden
